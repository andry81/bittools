...
* to sync:
  ...
  corr mean min/used/max:        0.316789 / 1.000000 / 1.000000
  num corr means calc:           169405007
  num corr values iter:          1453556015
  corr means mem accum/max:      1 / 409600 Kb
  corr means mem used:           748 Kb
...
* to sync with input noise:
  ...
  corr value min/max:            0.119832 / 0.954071
  corr mean min/used/max:        0.228367 / 0.865834 / 0.881841
  num corr means calc:           169405007
  num corr values iter:          1453556015
  corr means mem accum/max:      72 / 409600 Kb
  corr means mem used:           748 Kb
  stream bit length:             32000
